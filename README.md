# TP3 – IoT System with MQTT+ ESP32 + DHT22 + LCD + + Led + Buzzer + Cloud Integration
...
* turn on LED and turn son BUZZER when temperature > 24°C
* Visualize data on mobile dashboard

This is a complete real-world IoT architecture.
